...
export const useTagsQueryKey = (): QueryKey => {
  ...
  return [
    ...
    {
      baseRepository: workspacesContext.currentWorkspace.baseRepository,
      repositories: workspacesContext.currentWorkspace.repositories,
    },
    "tags",
  ];
};
