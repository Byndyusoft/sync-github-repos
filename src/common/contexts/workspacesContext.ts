...
export interface IWorkspacesContext {
  readonly workspaces: readonly IWorkspace[];
  readonly setWorkspaces: Dispatch<SetStateAction<readonly IWorkspace[]>>;

  readonly currentWorkspaceName: string;
  readonly setCurrentWorkspaceName: Dispatch<SetStateAction<string>>;
